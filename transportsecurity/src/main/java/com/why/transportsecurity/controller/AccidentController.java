...
import com.why.transportsecurity.entity.*;
import com.why.transportsecurity.service.AccidentServiceImpl;
import com.why.transportsecurity.utils.*;
...
public class AccidentController {
    ...
    public String warning(Model model){
        List<com.why.transportsecurity_finally.entity.TotalInfo> totalInfos = accidentService.totalInfo();
    ...
    public String detailsInfo(HttpServletRequest request,Model model){
        ...
        com.why.transportsecurity_finally.entity.DetailInfo detailInfo = accidentService.detailInfo(vId,aId);
        com.why.transportsecurity_finally.entity.VehicleInfo vehicleInfo = accidentService.vehicleInfo(vId);
    ...
    public String showTask(Model model, @RequestParam("vId") Integer vId, @RequestParam("aId") Integer aId,HttpServletRequest request){
        ...
        List<com.why.transportsecurity_finally.entity.Acceleration> axs = new ArrayList<>();
        for (int i = 0; i < 3; i++) {
            axs.add(new com.why.transportsecurity_finally.entity.Acceleration(ax.get(i),ay.get(i)));
        }
        model.addAttribute("aId",aId);
        model.addAttribute("vId",vId);
    ...
    public void show(HttpServletResponse response, @RequestParam Integer vId, @RequestParam Integer aId){
        ...
        List<com.why.transportsecurity_finally.entity.InfoExcelModel> list = new ArrayList<>();
        com.why.transportsecurity_finally.entity.InfoExcelModel infoExcelModel = new com.why.transportsecurity_finally.entity.InfoExcelModel();
        ...
        com.why.transportsecurity_finally.utils.OutputFileUtils.outputFile(list,response);
    }
    ...
    public String search(HttpServletRequest request,Model model){
        ...
        List<com.why.transportsecurity_finally.entity.TotalInfo> totalInfos = accidentService.search(search);
        if (totalInfos.size() != 0){
            if (!totalInfos.get(0).isStatus()){
                model.addAttribute("flag",true);
            }else {
